      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <Card variant="outlined">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <span className="w-8 h-8 bg-idusOrange/10 rounded-lg flex items-center justify-center text-sm">🌏</span>
            ...
            {/* 퀴즈 */}
            <div className="flex items-center gap-3 p-3 bg-idusOrange/5 rounded-lg border border-idusOrange/10">
              <span className="w-8 h-8 bg-idusOrange/10 rounded-lg flex items-center justify-center text-sm">🎯</span>
              <div className="flex-1">
        ...
        <div className="mt-8 text-center">
          ...
          <a 
            ...
            className="text-idusOrange hover:underline text-sm"
          >
            채널톡으로 문의하기
          </a>
        </div>
