...
export default function GiftOption() {
  return (
    <div className="bg-gradient-to-br from-white to-purple-50/30 rounded-2xl p-6 border border-idus-black-10">
      {/* 헤더 - 경고 스타일 */}
      <div className="flex items-center gap-3 mb-6 bg-purple-50 border border-purple-200 rounded-xl p-4">
        <div className="w-12 h-12 rounded-xl bg-purple-500 flex items-center justify-center shadow-lg shadow-purple-500/20">
          <Gift className="w-6 h-6 text-white" />
        </div>
        <div>
          <div className="font-bold text-purple-700 text-lg">🎁 사은품도 옵션 등록이 필수!</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
        ...
        >
          ...
          <div className="text-red-700 font-bold mb-4 flex items-center gap-2">
            <X className="w-5 h-5" />
            <span>❌ 잘못된 방법</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-lg p-3 border border-red-200">
              <div className="flex items-center gap-2 text-sm">
                <Package className="w-4 h-4 text-idus-black-50" />
                <span className="text-idus-black font-medium">귀걸이 세트</span>
                <span className="ml-auto text-idus-black-50">25,000원</span>
              </div>
            </div>

            {/* 사은품 미등록 */}
            <div className="bg-red-100 rounded-lg p-3 border border-red-300 border-dashed relative">
        ...
        >
          ...
          <div className="space-y-3">
            ...
            {/* 사은품 옵션으로 등록 */}
            <div className="bg-green-100 rounded-lg p-3 border border-green-300 relative">
              <div className="absolute -top-2 -right-2">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="ml-auto text-green-600 font-bold">0원</span>
              </div>
      ...
      {/* 설정 방법 안내 */}
      <motion.div 
        className="bg-white rounded-xl p-4 border border-idus-black-10 mb-5"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3 }}
      >
        <div className="flex items-center gap-2 mb-3">
          <Settings className="w-5 h-5 text-idus-orange" />
          <span className="font-bold text-idus-black">사은품 옵션 설정 방법</span>
        </div>
        <ol className="text-sm text-idus-black-70 space-y-2 ml-5">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="font-bold text-amber-800 mb-1">왜 옵션으로 등록해야 하나요?</div>
